...
Variants come from :data:`tengri.parameters.groups._VALID_NEBULAR_TYPES`:
...
``cb19`` (per :mod:`tengri.parameters._param_defs`), with ``cb19``
...
>>> builders.neb.cue(wildcard=FREE, fesc=Uniform(0.0, 0.5))  # doctest: +SKIP
