...
These are **pure functions** taking explicit arguments (no ``model`` object),
so they work inside ``@jax.jit`` closures as well as plain Python.
...
components (nebular / shock), was removed in #2223: it had no public callers
left (``SEDModel._attenuate_line_catalog`` and the deprecated
...
# ═══════════════════════════════════════════════════════════════════════════
# 2. Component emission (nebular / AGN / dust-IR / radio / X-ray)
# ═══════════════════════════════════════════════════════════════════════════
