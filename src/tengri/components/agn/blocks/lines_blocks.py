...
@register_agn_block("lines", "nlr_synthesizer_spectra")
def nlr_synthesizer_spectra_lines_block(
    wavelength: Array,
    agn_log_lbol: float,
    l5100_disc: Array,
    *,
...
@register_agn_block("lines", "blr_synthesizer_spectra")
def blr_synthesizer_spectra_lines_block(
    wavelength: Array,
    agn_log_lbol: float,
    l5100_disc: Array,
    *,
    ...
    **_params,
    ...
    Broad-line sibling of :func:`nlr_synthesizer_spectra_lines_block`, reading the
