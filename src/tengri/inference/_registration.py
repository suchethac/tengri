...
register_backend(
    ...
    short_doc=(
        ...
        "The cause is structural -- the Gaussian comes from a LOW-RANK inverse "
        "Hessian read off the L-BFGS history, and these posteriors run "
        "cond 1e5-1e8, so the soft directions are the ones the estimate cannot "
        "see. precondition=True roughly halves the collapse (worst 0.11 -> 0.21) "
