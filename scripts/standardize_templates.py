...
def write_dl07(outpath: str) -> None:
    ...
    from tengri.dust.emission import load_draine_li_templates
...
def write_dl14(outpath: str) -> None:
    ...
    from tengri.dust.emission import load_dl14_templates
...
def write_dale2014(outpath: str) -> None:
    ...
    from tengri.dust.emission import create_dale2014_from_grid
...
def write_astrodust(outpath: str) -> None:
    ...
    from tengri.dust.emission import load_astrodust_templates
...
def write_themis(outpath: str) -> None:
    ...
    from tengri.dust.emission import load_themis_templates
...
def write_bosa(outpath: str) -> None:
    ...
    from tengri.dust.emission import load_bosa_templates
