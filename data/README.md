...
| `fsps_mist_miles_chabrier.h5` | FSPS with MIST isochrones and the MILES library, Chabrier IMF — the default grid (`DEFAULT_SSP`) | generated from upstream FSPS / python-fsps | FSPS itself MIT; python-fsps MIT; SSP grid derived under those terms |
| `fsps_prsc_miles_chabrier.h5` | FSPS with PARSEC isochrones and the MILES library, Chabrier IMF | generated from upstream FSPS / python-fsps | FSPS itself MIT; python-fsps MIT; SSP grid derived under those terms |
