#!/usr/bin/env python
"""Build NB01: The IFT Correlated Field Model.

Theory-first notebook building physical intuition for the correlated field
model before any fitting machinery. Like a methods paper introduction.

Usage:
    python notebooks/_build_nb01.py
"""
...
cells = [
    ...
    **Building physical intuition for stochastic star formation histories**
    ...
    # -------------------------------------------------------------------------
    # Cell 2: Burstiness evidence plot
    # -------------------------------------------------------------------------
    code(r"""
    import jax
    ...
    # -------------------------------------------------------------------------
    # Cell 3: SFH decomposition equation
    # -------------------------------------------------------------------------
    md(r"""
    ...
    **Analogy**: think of $\overline{\mathrm{SFR}}$ as the *climate* (long-term
    ...
    # -------------------------------------------------------------------------
    # Cell 6: PSD physical timescale table
    # -------------------------------------------------------------------------
    md(r"""
    ...
    *If $\tau = 50\,$Myr, a burst lasts about the lifetime of a
    ...
    # -------------------------------------------------------------------------
    # Cell 8: GP generation explanation
    # -------------------------------------------------------------------------
    md(r"""
    ...
    *standardized* space where the prior is simply $\mathcal{N}(0, I)$,
    ...
    # -------------------------------------------------------------------------
    # Cell 9: GP realizations — 2x2 grid
    # -------------------------------------------------------------------------
    code(r"""
    ...
    **Convention**: `double_powerlaw` takes **lookback time** $t$ in years.
    ...
    # -------------------------------------------------------------------------
    # Cell 12: Parameter exploration — 1x3 panel
    # -------------------------------------------------------------------------
    code(r"""
    ...
    # -------------------------------------------------------------------------
    # Cell 14: Assembly demo — 4-panel step-by-step
    # -------------------------------------------------------------------------
    code(r"""
    ...
    # -------------------------------------------------------------------------
    # Cell 15: Lognormal bias demonstration
    # -------------------------------------------------------------------------
    code(r"""
    ...
    # -------------------------------------------------------------------------
    # Cell 16: Burstiness plane header
    # -------------------------------------------------------------------------
    md(r"""
    ...
    # -------------------------------------------------------------------------
    # Cell 17: Burstiness plane — 3x3 grid
    # -------------------------------------------------------------------------
    code(r"""
    ...
    # -------------------------------------------------------------------------
    # Cell 18: Ensemble properties — derived observables
    # -------------------------------------------------------------------------
    code(r"""
    ...
    # -------------------------------------------------------------------------
    # Cell 19: Parameter summary table
    # -------------------------------------------------------------------------
    md(r"""
    ## Parameter summary
    ...
    # -------------------------------------------------------------------------
    # Cell 20: Differentiability header
    # -------------------------------------------------------------------------
    md(r"""
    ...
    # -------------------------------------------------------------------------
    # Cell 21: Gradient demonstration
    # -------------------------------------------------------------------------
    code(r"""
...
if __name__ == "__main__":
    write_notebook("notebooks/01_the_model.ipynb", cells)
