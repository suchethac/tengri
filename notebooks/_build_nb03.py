#!/usr/bin/env python
"""Build NB03: Three Ways to Sample the Posterior.

Centerpiece educational notebook comparing MAP, Ray Tracing, geoVI,
NUTS, and MGVI inference methods on both parametric and stochastic
SED models.

Usage:
    python notebooks/_build_nb03.py
"""
...
cells = [
    ...
    **Key tuning:** use 4–12 samples per KL iteration (not 80 — see
    ...
    # ------------------------------------------------------------------
    # 31. Stochastic NUTS (expected failure)
    # ------------------------------------------------------------------
    code(r'''
...
write_notebook("notebooks/03_inference_methods.ipynb", cells)
