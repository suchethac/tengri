#!/usr/bin/env python
"""Build NB07: Fitting Galaxy Spectra.

Practical recipes for spectroscopic fitting — generating mock spectra,
fitting with MAP + Ray Tracing, residual analysis, SNR effects, and
comparing photometric vs spectroscopic constraints.

Usage:
    python notebooks/_build_nb07.py
"""
...
cells = [
    ...
    **What to look for:**
    ...
    # ------------------------------------------------------------------
    # 12. Photometry vs spectroscopy header
    # ------------------------------------------------------------------
    md(r'''
    ...
    # ------------------------------------------------------------------
    # 13. Photometry vs spectroscopy comparison
    # ------------------------------------------------------------------
    code(r'''
...
write_notebook("notebooks/07_spectroscopic_fitting.ipynb", cells)
