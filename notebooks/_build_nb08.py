#!/usr/bin/env python
"""Build NB08: Connecting PSD Parameters to Astrophysics.

Deep dive into the physics encoded by the PSD burstiness prior.
Connects PSD parameters (sigma, tau) to astrophysical mechanisms,
observable diagnostics, and the literature.

Usage:
    python notebooks/_build_nb08.py
"""
...
write_notebook("notebooks/08_psd_physics.ipynb", cells)
