...
ax.semilogy(ages_gyr, np.array(sfr_tsn), lw=1.5, label="tsnorm (default)")
...
ax.semilogy(ages_gyr, np.array(sfr_early), lw=1, ls="--", label="Early former")
ax.semilogy(ages_gyr, np.array(sfr_late), lw=1, ls="-.", label="Late former")
ax.semilogy(ages_gyr, np.array(sfr_broad), lw=1, ls=":", label="Broad history")
