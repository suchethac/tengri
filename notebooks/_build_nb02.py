#!/usr/bin/env python
"""Build NB02: "From SFH to Observable SED" — walk through the SPS pipeline."""
...
# ---------------------------------------------------------------------------
# Cell 0 — Title + pipeline overview
# ---------------------------------------------------------------------------
cells = [
    md('''
    ...
    **age-metallicity degeneracy**: an old, metal-poor population can
    ...
    # -----------------------------------------------------------------------
    # Cell 10 — Filter convolution header
    # -----------------------------------------------------------------------
    md('''
    ## Filter Convolution
...
# Write the notebook
# ---------------------------------------------------------------------------
write_notebook("notebooks/02_forward_model.ipynb", cells)
