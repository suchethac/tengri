#!/usr/bin/env python
"""Build NB09: "Extending diffsed" — developer guide.

Shows how the standardized architecture makes diffsed extensible:
custom priors, PSD models, dust laws, mean SFHs, filter sets.
The key insight: one loss function, any prior, any sampler.
"""
...
cells = [
    ...
    **To extend diffsed, you swap one layer.  Everything else composes.**
    ...
    # -----------------------------------------------------------------------
    # Cell 5 — Distribution visualization
    # -----------------------------------------------------------------------
    code('''
    ...
    # -----------------------------------------------------------------------
    # Cell 7 — Custom prior: TruncatedCauchy
    # -----------------------------------------------------------------------
    code('''
    ...
    # -----------------------------------------------------------------------
    # Cell 13 — Custom mean SFH header
    # -----------------------------------------------------------------------
    md('''
    ...
    **Important:** The metallicity grid uses $\\log_{10}(Z)$ absolute, **not**
    ...
    # -----------------------------------------------------------------------
    # Cell 18 — Free PSD params header
    # -----------------------------------------------------------------------
    md('''
...
# Write the notebook
# ---------------------------------------------------------------------------
write_notebook("notebooks/09_custom_models.ipynb", cells)
