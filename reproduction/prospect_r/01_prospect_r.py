...
# This study configures tengri's public API to approximate ProSpect's model choices; it is not a port of ProSpect, and residual differences are documented below.
#
