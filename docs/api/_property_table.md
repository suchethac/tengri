...
| `civ_1549` | Lsun | lines | nebular | CIV 1549 line luminosity, NaN with a warning on cue's legacy 128-line subset (full_catalog=false), where no catalog line falls within tolerance of this wavelength (#2239) |
