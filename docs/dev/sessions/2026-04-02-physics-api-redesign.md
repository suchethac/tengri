...
```python
from tengri.models.agn._phys import H_PLANCK as _H_PLANCK, K_BOLTZ as _K_BOLTZ
from tengri.models.agn._phys import C_LIGHT as _C_LIGHT, ANGSTROM_CM as _ANGSTROM_CM
from tengri.models.agn._phys import planck_lnu as _planck_lnu
from tengri.models.agn._phys import wavelength_to_nu as _wavelength_to_nu
```
...
python -c "from tengri.models.agn import disc, torus, skirtor; print('OK')"
```
...
cd ~/Projects/tengri && source .venv/bin/activate
python -c "
from tengri.models.observation.eline_marginalization import DEFAULT_LINE_NAMES, DEFAULT_LINE_WAVELENGTHS
from tengri.models.observation.eline_priors import CLOUDY_LINE_NAMES, CLOUDY_LINE_WAVELENGTHS
...
```python
    def predict_hbeta(self, params: dict) -> float:
        ...
        from tengri.models.nebular.agn_nebular import _log_q_h_from_stellar_sed
