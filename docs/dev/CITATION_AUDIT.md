...
The following 95 references are found in `/Users/suchethacooray/writing-workspace/projects/tengri/99-references.bib`.
...
- This audit was generated by scanning all Python files in `/Users/suchethacooray/Projects/tengri/src/tengri/` for numpydoc-style `.. [N] Author, Year, ...` references.
