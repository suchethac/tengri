...
| [`12_simulation_populations`](spine/12_simulation_populations) | Forward-modeling tabulated SFH and Z(t) histories from a simulation to photometry and emission lines, and how to make it fast (`jit(vmap)`, `WavePrecomp`, batch width, `float32`) |
