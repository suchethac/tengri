...
.. image-sg:: /auto_examples/workflows/images/sphx_glr_plot_workflow_high_z_lbg_001.png
   :alt: High-z Lyman-Break Galaxy (z=4.0): JWST+HST photometry
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/suchethacooray/Projects/tengri/examples/workflows/plot_workflow_high_z_lbg.py:171: UserWarning: This figure includes Axes that are not compatible with tight_layout, so results might be incorrect.
      fig.tight_layout()
