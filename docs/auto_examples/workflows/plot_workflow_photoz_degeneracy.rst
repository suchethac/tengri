...
.. "auto_examples/workflows/plot_workflow_photoz_degeneracy.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_workflows_plot_workflow_photoz_degeneracy.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_workflows_plot_workflow_photoz_degeneracy.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 22-169



.. image-sg:: /auto_examples/workflows/images/sphx_glr_plot_workflow_photoz_degeneracy_001.png
   :alt: plot workflow photoz degeneracy
   :srcset: /auto_examples/workflows/images/sphx_glr_plot_workflow_photoz_degeneracy_001.png
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_workflow_photoz_degeneracy.ipynb <plot_workflow_photoz_degeneracy.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_workflow_photoz_degeneracy.py <plot_workflow_photoz_degeneracy.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_workflow_photoz_degeneracy.zip <plot_workflow_photoz_degeneracy.zip>`
