...
.. "auto_examples/showcase/plot_gradient_degeneracy_direction.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_showcase_plot_gradient_degeneracy_direction.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_showcase_plot_gradient_degeneracy_direction.py:
...
.. image-sg:: /auto_examples/showcase/images/sphx_glr_plot_gradient_degeneracy_direction_001.png
   :alt: plot gradient degeneracy direction
   :srcset: /auto_examples/showcase/images/sphx_glr_plot_gradient_degeneracy_direction_001.png
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_gradient_degeneracy_direction.ipynb <plot_gradient_degeneracy_direction.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_gradient_degeneracy_direction.py <plot_gradient_degeneracy_direction.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_gradient_degeneracy_direction.zip <plot_gradient_degeneracy_direction.zip>`
