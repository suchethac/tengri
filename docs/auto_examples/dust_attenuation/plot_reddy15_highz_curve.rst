...
.. "auto_examples/dust_attenuation/plot_reddy15_highz_curve.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_dust_attenuation_plot_reddy15_highz_curve.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_dust_attenuation_plot_reddy15_highz_curve.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_reddy15_highz_curve.ipynb <plot_reddy15_highz_curve.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_reddy15_highz_curve.py <plot_reddy15_highz_curve.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_reddy15_highz_curve.zip <plot_reddy15_highz_curve.zip>`
