...
.. "auto_examples/nebular/plot_balmer_decrement_dust.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_nebular_plot_balmer_decrement_dust.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_nebular_plot_balmer_decrement_dust.py:
...
.. image-sg:: /auto_examples/nebular/images/sphx_glr_plot_balmer_decrement_dust_001.png
   :alt: plot balmer decrement dust
   :srcset: /auto_examples/nebular/images/sphx_glr_plot_balmer_decrement_dust_001.png
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (1 minutes 45.754 seconds)


.. _sphx_glr_download_auto_examples_nebular_plot_balmer_decrement_dust.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_balmer_decrement_dust.ipynb <plot_balmer_decrement_dust.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_balmer_decrement_dust.py <plot_balmer_decrement_dust.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_balmer_decrement_dust.zip <plot_balmer_decrement_dust.zip>`
