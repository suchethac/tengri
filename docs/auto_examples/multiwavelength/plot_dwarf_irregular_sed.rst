...
.. "auto_examples/multiwavelength/plot_dwarf_irregular_sed.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_multiwavelength_plot_dwarf_irregular_sed.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_multiwavelength_plot_dwarf_irregular_sed.py:


Panchromatic SED of a low-metallicity dwarf irregular galaxy
=============================================================

.. image:: images/sphx_glr_plot_dwarf_irregular_sed_001.png
   :alt: plot dwarf irregular sed
...
.. image-sg:: /auto_examples/multiwavelength/images/sphx_glr_plot_dwarf_irregular_sed_001.png
   :alt: plot dwarf irregular sed
   :srcset: /auto_examples/multiwavelength/images/sphx_glr_plot_dwarf_irregular_sed_001.png
   :class: sphx-glr-single-img
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_dwarf_irregular_sed.ipynb <plot_dwarf_irregular_sed.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_dwarf_irregular_sed.py <plot_dwarf_irregular_sed.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_dwarf_irregular_sed.zip <plot_dwarf_irregular_sed.zip>`
