...
.. "auto_examples/photometry/plot_emission_line_contamination.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_photometry_plot_emission_line_contamination.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_photometry_plot_emission_line_contamination.py:
...
.. image-sg:: /auto_examples/photometry/images/sphx_glr_plot_emission_line_contamination_001.png
   :alt: plot emission line contamination
   :srcset: /auto_examples/photometry/images/sphx_glr_plot_emission_line_contamination_001.png
...
.. _sphx_glr_download_auto_examples_photometry_plot_emission_line_contamination.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_emission_line_contamination.ipynb <plot_emission_line_contamination.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_emission_line_contamination.py <plot_emission_line_contamination.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_emission_line_contamination.zip <plot_emission_line_contamination.zip>`
