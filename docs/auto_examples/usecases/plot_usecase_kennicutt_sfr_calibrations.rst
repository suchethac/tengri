...
.. "auto_examples/usecases/plot_usecase_kennicutt_sfr_calibrations.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_usecases_plot_usecase_kennicutt_sfr_calibrations.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_usecases_plot_usecase_kennicutt_sfr_calibrations.py:
...
.. image-sg:: /auto_examples/usecases/images/sphx_glr_plot_usecase_kennicutt_sfr_calibrations_001.png
   :alt: Baseline: Kennicutt+1998 (constant SFR assumption), Stochastic SFH: SFR indicator variance across burstiness levels
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_usecase_kennicutt_sfr_calibrations.ipynb <plot_usecase_kennicutt_sfr_calibrations.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_usecase_kennicutt_sfr_calibrations.py <plot_usecase_kennicutt_sfr_calibrations.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_usecase_kennicutt_sfr_calibrations.zip <plot_usecase_kennicutt_sfr_calibrations.zip>`
