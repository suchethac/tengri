...
.. "auto_examples/dust/plot_two_component.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_dust_plot_two_component.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_dust_plot_two_component.py:
...
.. image-sg:: /auto_examples/dust/images/sphx_glr_plot_two_component_001.png
   :alt: Age-Dependent Dust Transmission, Birth Cloud + Diffuse ISM ($\tau_{\rm bc}=1.5$, $\tau_{\rm diff}=0.3$)
   :srcset: /auto_examples/dust/images/sphx_glr_plot_two_component_001.png
...
.. _sphx_glr_download_auto_examples_dust_plot_two_component.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_two_component.ipynb <plot_two_component.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_two_component.py <plot_two_component.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_two_component.zip <plot_two_component.zip>`
