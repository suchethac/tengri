...
.. GENERATED FROM PYTHON SOURCE LINES 16-120



.. image-sg:: /auto_examples/sps/images/sphx_glr_plot_ssp_grid_001.png
   :alt: SSP Grid: Age and Metallicity Evolution, Age Sequence (Z=0.06 Z$_\odot$), Metallicity Sequence (Age=1.00 Gyr), Broad-Band Flux vs Age (Z=0.06 Z$_\odot$), SSP Color-Color Diagram (all metallicities)
