...
.. "auto_examples/agn/plot_polar_dust_ebv_sweep.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_agn_plot_polar_dust_ebv_sweep.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_agn_plot_polar_dust_ebv_sweep.py:


Polar-dust E(B-V) sweep for Type 1 and Type 2 AGN sightlines (X-CIGALE)
========================================================================

.. image:: images/sphx_glr_plot_polar_dust_ebv_sweep_001.png
...
.. _sphx_glr_download_auto_examples_agn_plot_polar_dust_ebv_sweep.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_polar_dust_ebv_sweep.ipynb <plot_polar_dust_ebv_sweep.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_polar_dust_ebv_sweep.py <plot_polar_dust_ebv_sweep.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_polar_dust_ebv_sweep.zip <plot_polar_dust_ebv_sweep.zip>`
