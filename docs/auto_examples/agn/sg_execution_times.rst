...
.. _sphx_glr_auto_examples_agn_sg_execution_times:


Computation times
=================
**00:12.382** total execution time for 37 files **from auto_examples/agn**:
...
.. container::
   ...
   * - :ref:`sphx_glr_auto_examples_agn_plot_variability_continuum_lag.py` (``plot_variability_continuum_lag.py``)
     - 00:00.387
     - 0.0
   * - :ref:`sphx_glr_auto_examples_agn_plot_agn_bolometric_correction.py` (``plot_agn_bolometric_correction.py``)
     - 00:00.027
     - 0.0
