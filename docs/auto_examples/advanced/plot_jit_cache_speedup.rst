...
.. "auto_examples/advanced/plot_jit_cache_speedup.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_advanced_plot_jit_cache_speedup.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_advanced_plot_jit_cache_speedup.py:


The persistent JIT cache turns the second-run cold start into a no-op
=====================================================================

.. image:: images/sphx_glr_plot_jit_cache_speedup_001.png
   :alt: plot jit cache speedup
...
.. GENERATED FROM PYTHON SOURCE LINES 27-172
...
.. _sphx_glr_download_auto_examples_advanced_plot_jit_cache_speedup.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_jit_cache_speedup.ipynb <plot_jit_cache_speedup.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_jit_cache_speedup.py <plot_jit_cache_speedup.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_jit_cache_speedup.zip <plot_jit_cache_speedup.zip>`
