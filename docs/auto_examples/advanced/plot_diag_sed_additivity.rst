...
.. "auto_examples/advanced/plot_diag_sed_additivity.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_advanced_plot_diag_sed_additivity.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_advanced_plot_diag_sed_additivity.py:


SED additivity: stellar, dust attenuation, emission, and nebular components
===========================================================================

.. image:: images/sphx_glr_plot_diag_sed_additivity_001.png
   :alt: plot diag sed additivity
...
.. image-sg:: /auto_examples/advanced/images/sphx_glr_plot_diag_sed_additivity_001.png
   :alt: plot diag sed additivity
   :srcset: /auto_examples/advanced/images/sphx_glr_plot_diag_sed_additivity_001.png
   :class: sphx-glr-single-img
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_diag_sed_additivity.ipynb <plot_diag_sed_additivity.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_diag_sed_additivity.py <plot_diag_sed_additivity.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_diag_sed_additivity.zip <plot_diag_sed_additivity.zip>`
