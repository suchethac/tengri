...
.. "auto_examples/advanced/plot_diag_ab_mag_zero_point.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_advanced_plot_diag_ab_mag_zero_point.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_advanced_plot_diag_ab_mag_zero_point.py:
...
.. image-sg:: /auto_examples/advanced/images/sphx_glr_plot_diag_ab_mag_zero_point_001.png
   :alt: plot diag ab mag zero point
   :srcset: /auto_examples/advanced/images/sphx_glr_plot_diag_ab_mag_zero_point_001.png
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: plot_diag_ab_mag_zero_point.ipynb <plot_diag_ab_mag_zero_point.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: plot_diag_ab_mag_zero_point.py <plot_diag_ab_mag_zero_point.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: plot_diag_ab_mag_zero_point.zip <plot_diag_ab_mag_zero_point.zip>`
