...
exclude_patterns = [
    ...
    "internal",
    "**.ipynb_checkpoints",
    # Registry tables written by _write_component_reference each build. They are
    # ``.. include::``-ed into components.md, so as a *source document* the
    # fragment is an orphan — and an orphan is a warning, which -W makes a
    # build failure.
    "_generated",
    "superpowers",
    "specs",
