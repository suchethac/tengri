...
def test_monolithic_agn_float32_finite(synthetic_ssp):
    """Monolithic AGN in float32 must stay finite with the reference factoring."""
    with jax.enable_x64(False):
        ...
        params = {
            "sfh_delayed_log_total_mass": jnp.float32(10.0),
            "agn_log_lbol": jnp.float32(12.0),
        }
