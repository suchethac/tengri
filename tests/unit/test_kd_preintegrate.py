...
class TestPlanckFilterTable:
    ...
    def test_planck_table_shape(self):
        from tengri.models.agn.kd_preintegrate import _build_planck_filter_table
    ...
    def test_planck_lookup_matches_direct(self):
        ...
        from tengri.models.agn.kd_preintegrate import (
...
class TestCoronaFilterTable:
    ...
    def test_corona_table_shape(self):
        from tengri.models.agn.kd_preintegrate import _build_corona_filter_table
...
class TestNthcompFilterTable:
    ...
    def test_nthcomp_table_loads(self):
        ...
        from tengri.models.agn.kd_preintegrate import _build_nthcomp_filter_table
