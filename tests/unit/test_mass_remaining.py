...
class TestChabrierIMF:
    ...
    def test_positive_output(self):
        from tengri.components.sps.mass_remaining import _chabrier_imf
...
class TestSalpeterIMF:
    ...
    def test_positive_output(self):
        from tengri.components.sps.mass_remaining import _salpeter_imf
...
class TestKroupaIMF:
    ...
    def test_positive_output(self):
        from tengri.components.sps.mass_remaining import _kroupa_imf
...
class TestTurnoffMass:
    ...
    def test_roundtrip_consistency(self):
        ...
        from tengri.components.sps.mass_remaining import _ms_lifetime_gyr, _turnoff_mass
...
class TestRemnantMass:
    ...
    def test_below_0p5_returns_initial_mass(self):
        ...
        from tengri.components.sps.mass_remaining import _remnant_mass
