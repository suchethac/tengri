...
class TestGradients:
    ...
    def test_grad_wrt_continuum(self, simple_setup):
        ...
        chex.assert_tree_all_finite(grad), "Gradient w.r.t. continuum should be finite"
    ...
    def test_grad_wrt_noise(self, simple_setup):
        ...
        chex.assert_tree_all_finite(grad), "Gradient w.r.t. noise should be finite"
    ...
    def test_grad_through_predict(self, simple_setup):
        ...
        grad = jax.grad(loss)(jnp.ones_like(wave))
        chex.assert_tree_all_finite(grad), "Gradient through predict should be finite"
