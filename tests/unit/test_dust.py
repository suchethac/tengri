"""Tests for Charlot & Fall dust attenuation model."""
...
from diffsed.models.dust.charlot_fall import charlot_fall, charlot_fall_hard

jax.config.update("jax_enable_x64", True)


class TestCharlotFall:
    """Tests for the smooth Charlot & Fall dust model."""
    ...
    def test_no_dust_gives_unity(self, wavelength, age_grid):
        ...
        atten = charlot_fall(wavelength, age_grid, 0.0, 0.0)
    ...
    def test_more_dust_less_transmission(self, wavelength, age_grid):
        ...
        atten_low = charlot_fall(wavelength, age_grid, 0.3, 0.1)
        atten_high = charlot_fall(wavelength, age_grid, 1.5, 0.5)
    ...
    def test_young_stars_more_attenuated(self, wavelength, age_grid):
        ...
        atten = charlot_fall(wavelength, age_grid, 1.0, 0.3)
    ...
    def test_bluer_wavelengths_more_attenuated(self, age_grid):
        ...
        atten = charlot_fall(wave, age_grid, 0.5, 0.3, n_slope=-0.7)
    ...
    def test_v_band_optical_depth(self, age_grid):
        ...
        tau_v2 = 0.5
        atten = charlot_fall(wave, age_grid, 0.0, tau_v2, n_slope=-0.7)
    ...
    def test_is_jittable(self, wavelength, age_grid):
        """Charlot & Fall is JIT-compatible."""
        fn = jax.jit(charlot_fall)
...
class TestCharlotFallHard:
    """Tests for the step-function variant."""
    ...
    def test_agrees_with_smooth_away_from_transition(self):
        ...
        atten_smooth = charlot_fall(wave, ages, 0.5, 0.3)
        atten_hard = charlot_fall_hard(wave, ages, 0.5, 0.3)
