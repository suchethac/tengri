...
def test_feltre_predict_returns_finite() -> None:
    ...
    chex.assert_tree_all_finite(wave), "Line wavelengths contain non-finite values"
    chex.assert_tree_all_finite(lum), "Line luminosities contain non-finite values"
