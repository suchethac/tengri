...
def _build_shock_dust_model():
    ...
    model = SEDModel.build(
        ...
        dust={"type": "two_component", "all_params": FIXED, "tau_bc": 2.0, "tau_diff": 1.0},
        neb={"type": "none"},
...
class TestShockAttenuationPhysics:
    ...
    def test_band_dependent_dimming_ratio_ordering(self):
        ...
        model_notau = SEDModel.build(
            ...
            dust={"type": "two_component", "all_params": FIXED, "tau_bc": 0.0, "tau_diff": 0.0},
            neb={"type": "none"},
            shock={"frac": 1.0, "all_params": FIXED},
            redshift=Fixed(0.05),
        )
    ...
    def test_single_component_dust_shock_nonzero(self):
        ...
        model_exact = SEDModel.build(
            ...
            dust={"type": "single_component", "all_params": FIXED, "tau_v": 1.0},
            neb={"type": "none"},
            shock={"frac": 1.0, "all_params": FIXED},
            redshift=Fixed(0.5),
            approx=None,
